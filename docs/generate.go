...
func main() {
    ...
    f.WriteString(fmt.Sprintf("  - name: role_tutor\n"))
    f.WriteString(fmt.Sprintf("    description: Endpoints for tutors\n"))
    f.WriteString(fmt.Sprintf("  - name: role_supertutor\n"))
    f.WriteString(fmt.Sprintf("    description: Endpoints for super tutors\n"))
    f.WriteString(fmt.Sprintf("  - name: role_student\n"))
    f.WriteString(fmt.Sprintf("    description: Endpoint for student\n"))
    f.WriteString(fmt.Sprintf("  - name: role_admin\n"))
    f.WriteString(fmt.Sprintf("    description: Endpoint for admin\n"))
